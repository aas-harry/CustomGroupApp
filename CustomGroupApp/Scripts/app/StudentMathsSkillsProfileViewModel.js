...
var StudentMathsSkillsProfileViewModel = (function (_super) {
    __extends(StudentMathsSkillsProfileViewModel, _super);
    function StudentMathsSkillsProfileViewModel(elementName) {
        var _this = this;
        ...
        this.reports = [
            new ReportItem("Maths Skills Profile", "StudentMathsSkillsProfileView", ReportType.StudentMathsSkillsProfile, this)
        ];
        ...
        this.setAdditionalData = function (callback) {
            if (_this.testFile.hasMathsQuestions) {
            ...
            $.ajax({
                type: "POST",
                url: "GetMathsQuestions",
                data: JSON.stringify({ 'id': self.testFile.mathsQuestionSetId }),
                contentType: "application/json",
                success: function (data) {
                    self.testFile.setMathsQuestions(data);
                    var tmpCallback = callback;
                    if (tmpCallback) {
                        tmpCallback(true);
                    }
        ...
        this.setAdditionalProperties = function (student) {
            _this.scoreProfile = student.mathPerformance.scoreProfile;
            _this.studentAnswers = _this.scoreProfile.getStudentAnswers(_this.testFile.mathsQuestions);
            _this.strandSummary = _this.scoreProfile.getStrandSummary(_this.studentAnswers);
            _this.strandLevels = Enumerable.From(_this.testFile.mathsQuestions)
    ...
    return StudentMathsSkillsProfileViewModel;
}(StudentPortfolio));
//# sourceMappingURL=StudentMathsSkillsProfileViewModel.js.map